(function() {
	...
	siteItems.components = angular.module('siteItems.components', ['parallax', 'contactMap', 'sitePhotos', 'errorPage', 'siteAlbum', 'siteBlog', 'sitePost', 'siteAbout', 'siteContact', 'homeItem']);
