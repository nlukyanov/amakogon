(function() {
	...
	siteItems.elements = angular.module('siteItems.elements', ['siteLogo', 'siteNav', 'siteBreadcrumbs', 'backToTop']);

	siteItems.components = angular.module('siteItems.components', ['parallax', 'contactMap', 'sitePhotos']);
